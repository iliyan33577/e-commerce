...
const Vase_Product = () => {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center h-96 bg-fixed bg-parallax3 bg-cover">
        <h1 className="text-5xl text-white uppercase">
          We offer a wide variety of Vase's
        </h1>
      </div>
              ...
              >
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    onClick={() => navigate(`/productvase/${items.id}`)}
                  >
                    <PreviewIcon /> View
                  </button>
                </div>
